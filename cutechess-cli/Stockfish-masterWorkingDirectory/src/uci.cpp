  ...
  do {
          ...
          || (token == "ponderhit" && Search::Signals.stopOnPonderhit))
      {
          ...
          sync_cout << "id name " << engine_info(true)
                    << "\n"       << Options
                    /*<< "\noption name PawnValueMg value " << PawnValueMg
                    << "\noption name PawnValueEg value " << PawnValueEg
                    << "\noption name KnightValueMg value " << KnightValueMg
                    << "\noption name KnightValueEg value " << KnightValueEg
                    << "\noption name BishopValueMg value " << BishopValueMg
                    << "\noption name BishopValueEg value " << BishopValueEg
                    << "\noption name RookValueMg value " << RookValueMg
                    << "\noption name RookValueEg value " << RookValueEg
                    << "\noption name QueenValueMg value " << QueenValueMg
                    << "\noption name QueenValueEg value " << QueenValueEg*/
                    << "\nuciok"  << sync_endl;
