...
enum Value : int {
  ...
  PawnValueMg   = 74,   PawnValueEg   = 258,
  KnightValueMg = 777,   KnightValueEg = 846,
  BishopValueMg = 798,   BishopValueEg = 857,
  RookValueMg   = 1132,  RookValueEg   = 1281,
  QueenValueMg  = 2499,  QueenValueEg  = 2558,
